import { _decorator, Component, Node, RenderTexture, UITransform, game, view, screen, Camera, NodeEventType } from 'cc';
const { ccclass, property } = _decorator;

@ccclass('SpriteToTexture')
export class SpriteToTexture extends Component {
