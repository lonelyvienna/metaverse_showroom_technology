 ...
 * @LastEditTime: 2022-06-15 23:02:15
...
export default abstract class BaseLoader {
     ...
     */
    public loadRes(path: string, type: typeof Asset, callback: (err, res) => void): void {
    ...
    // 加载网络资源
    public abstract loadNetRes(path: string, type: typeof Asset, callback: (err, res) => void): void;
    // 加载远程待下载资源
    public abstract loadRemoteRes(path: string, type: typeof Asset, callback: (err, res) => void): void;
    // 加载本地资源
    public abstract loadLocalRes(path: string, type: typeof Asset, callback: (err, res) => void): void;
